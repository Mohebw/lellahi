...
import { LayoutDashboard, Package, Tags, ClipboardList, LogOut, Menu, X, Smartphone, MessageSquare, ShoppingBag, Images, Zap } from "lucide-react";
...
const NAV = [
  ...
  { href: "/admin/banners", label: "بنرهای صفحه اصلی", icon: Images },
  { href: "/admin/promo-tiles", label: "باکس‌های تبلیغاتی", icon: Images },
  { href: "/admin/flash-sale", label: "پیشنهاد شگفت‌انگیز", icon: Zap },
